...
def test_end2end():
    ...
    sys_dst = RuleDST()
    # rule policy
    sys_policy = MultipleAgents(transfer=True)
    # template NLG
    ...
    user_dst = None
    # rule policy
    user_policy = RulePolicy(character='usr', generate_shared=True)
    # template NLG
    ...
    set_seed(20200202)
    analyzer.comprehensive_analyze(sys_agent=sys_agent, model_name='BERTNLU-RuleDST-MAPolicy-TemplateNLG-transfer', total_dialog=1000)
